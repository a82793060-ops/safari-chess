...
محرّك نقطة تحقّق (اختبارات اختيار + رقعة مصغّرة) لِـschool/rules/openings، ومحطة play (فوز على الهدف).
المرجع: `docs/phase2-track-spec.md`. **متبقٍّ:** اختبار آليّ لِـtactics/endgames (تفتحان مركز الألغاز حاليًّا)،
وم٣: تأليف دروس غنيّة (بمساعدة AI).
