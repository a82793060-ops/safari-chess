...
✅ **م٣ (v42→v46) — مكتملة بالكامل**: المسار الآن **٨ محطات، ٤٤ نقطة تحقّق** (يطابق `docs/phase3-*-spec.md`
تمامًا): `board_setup`(4)`school`(7)`special_moves`(4)`rules`(6)`openings`(5)`tactics`(7)`endgames`(6)`play`(5).
