...
const BOTS = [
  {
    ...
    phrases: {
      ar: {
        ...
        opening: ["واو! لهذه النقلات اسم؟ {name}؟ بيب!"],
        idle: ["هل نمت؟ بيب بيب!", "خذ وقتك... سأعد حبوبي"],
        winning: ["بيب بيب! أظن أنني أفوز!"],
        losing: ["أين ذهب جيشي؟ بييب!"],
        castle: ["ملكك اختبأ! هل نلعب الغميضة؟"],
        promote: ["بيدقك صار وزيرا؟! أريد واحدا مثله!"],
        enPassant: ["بيب؟! ما هذه النقلة السحرية؟!"],
        draw: ["لا أحد خسر! كلانا بطل!"],
      },
      en: {
        ...
        opening: ["Wow! These moves have a name? {name}? Peep!"],
        idle: ["Did you fall asleep? Peep peep!", "Take your time... I'll count my seeds"],
        winning: ["Peep peep! I think I'm winning!"],
        losing: ["Where did my army go? Peeeep!"],
        castle: ["Your king is hiding! Are we playing hide and seek?"],
        promote: ["Your pawn became a queen?! I want one too!"],
        enPassant: ["Peep?! What was that magic move?!"],
        draw: ["Nobody lost! We're both champions!"],
      },
    },
  },
  {
    ...
    phrases: {
      ar: {
        ...
        opening: ["{name}؟ اسم طويل... هيا نقفز إلى اللعب!"],
        idle: ["أسرع أسرع! الجزر ينتظرني!", "هيا! قفزة واحدة تكفي!"],
        winning: ["قطعي أكثر! سأقفز فرحا!"],
        losing: ["مهلا... أين اختفت قطعي؟!"],
        castle: ["ملكك قفز قفزتين! أرنب مثلي؟"],
        promote: ["ترقية؟! أنا أيضا أريد أن أكبر!"],
        enPassant: ["قفزة فوق البيدق! نقلة أرانب أصيلة!"],
        draw: ["تعادل بسرعة! هيا نعيد أسرع!"],
      },
      en: {
        ...
        opening: ["{name}? Long name... let's hop to it!"],
        idle: ["Faster faster! My carrots are waiting!", "Come on! One little hop!"],
        winning: ["More pieces for me! Victory hops!"],
        losing: ["Wait... where did my pieces go?!"],
        castle: ["Your king hopped two squares! A rabbit like me?"],
        promote: ["Promotion?! I want to grow up too!"],
        enPassant: ["A hop over the pawn! A true rabbit move!"],
        draw: ["A speedy draw! Rematch, but faster!"],
      },
    },
  },
  {
    ...
    phrases: {
      ar: {
        ...
        opening: ["{name}... افتتاحية أعرفها، سألعب على مهل"],
        idle: ["خذ وقتك... أنا أمضغ الخيزران", "لا تستعجل... التأمل جميل"],
        winning: ["الكفة تميل لصالحي... بهدوء"],
        losing: ["قطعي تتناقص... سأحافظ على هدوئي"],
        castle: ["بيّت ملكك... قرار هادئ وحكيم"],
        promote: ["وزير جديد... سأتعامل معه بهدوء"],
        enPassant: ["الأخذ في المرور... قاعدة قديمة وجميلة"],
        draw: ["تعادل هادئ... كلانا يستحق قيلولة"],
      },
      en: {
        ...
        opening: ["{name}... I know this one, I'll take it slow"],
        idle: ["Take your time... I'm chewing bamboo", "No rush... contemplation is beautiful"],
        winning: ["The scales tip my way... calmly"],
        losing: ["My pieces are fading... I shall stay calm"],
        castle: ["You castled... a calm, wise choice"],
        promote: ["A new queen... I'll handle it calmly"],
        enPassant: ["En passant... an old and beautiful rule"],
        draw: ["A peaceful draw... we both earned a nap"],
      },
    },
  },
  {
    ...
    phrases: {
      ar: {
        ...
        opening: ["{name}! افتتاحية تليق ببلاط الملك"],
        idle: ["الملك ينتظر... والملوك لا تحب الانتظار!", "زئير تحذيري: تحرك!"],
        winning: ["جيش الملك يكتسح السهول!"],
        losing: ["تمرد في مملكتي؟! غير مقبول!"],
        castle: ["تحصنت في قلعتك؟ القلاع لا توقف الملوك!"],
        promote: ["وزير جديد في بلاطك؟ عرشي لا يهتز!"],
        enPassant: ["أخذ في المرور! نقلة من زمن الملوك الأوائل"],
        draw: ["تعادل؟ سأعتبرها رحمة ملكية مني"],
      },
      en: {
        ...
        opening: ["{name}! An opening worthy of the royal court"],
        idle: ["The king waits... and kings hate waiting!", "A warning roar: move!"],
        winning: ["The king's army sweeps the savanna!"],
        losing: ["Rebellion in my kingdom?! Unacceptable!"],
        castle: ["Hiding in your castle? Castles don't stop kings!"],
        promote: ["A new queen at your court? My throne stands firm!"],
        enPassant: ["En passant! A move from the age of the first kings"],
        draw: ["A draw? Consider it royal mercy"],
      },
    },
  },
  {
    ...
    phrases: {
      ar: {
        ...
        opening: ["{name}... أعرف كل أفخاخ هذه الافتتاحية"],
        idle: ["تفكر طويلا... هل شممت رائحة الفخ؟", "خذ وقتك... خطتي تنضج على مهل"],
        winning: ["كل شيء يسير كما رسمته بالضبط"],
        losing: ["خسارة قطع... أم تضحية ماكرة؟ لن أخبرك"],
        castle: ["تبييت... تحاول إفساد خطتي؟"],
        promote: ["وزير جديد؟ لدي فخ لكل قطعة"],
        enPassant: ["الأخذ في المرور... أمكر نقلة في اللعبة!"],
        draw: ["تعادل... أذكى نهاية بين ماكرَين"],
      },
      en: {
        ...
        opening: ["{name}... I know every trap in this opening"],
        idle: ["Thinking long... did you smell the trap?", "Take your time... my plan ripens slowly"],
        winning: ["Everything is going exactly as I drew it"],
        losing: ["Lost pieces... or a cunning sacrifice? I won't tell"],
        castle: ["Castling... trying to spoil my plan?"],
        promote: ["A new queen? I have a trap for every piece"],
        enPassant: ["En passant... the slyest move in the game!"],
        draw: ["A draw... the cleverest end between two foxes"],
      },
    },
  },
  {
    ...
    phrases: {
      ar: {
        ...
        opening: ["آه، {name}! الفصل السابع من مكتبتي"],
        idle: ["التفكير الطويل من علامات الحكمة... غالبا", "تقول كتبي: من تأمل طويلا أصاب... أحيانا"],
        winning: ["الحسابات تؤكد تفوقي... كما توقعت الكتب"],
        losing: ["وضع غير مذكور في مراجعي... مقلق"],
        castle: ["التبييت... اختراع القرن السادس عشر، هل تعلم؟"],
        promote: ["ترقية! الفصل الأخير من كتاب البيادق"],
        enPassant: ["الأخذ في المرور! شهدت ولادة هذه القاعدة قبل قرون"],
        draw: ["التعادل نتيجة منطقية بين عقلين راجحين"],
      },
      en: {
        ...
        opening: ["Ah, {name}! Chapter seven of my library"],
        idle: ["Long thinking is a sign of wisdom... usually", "My books say: who ponders long, plays well... sometimes"],
        winning: ["The calculations confirm my edge... as the books foretold"],
        losing: ["A position absent from my references... troubling"],
        castle: ["Castling... a 16th-century invention, did you know?"],
        promote: ["Promotion! The final chapter of the book of pawns"],
        enPassant: ["En passant! I witnessed the birth of that rule centuries ago"],
        draw: ["A draw — the logical result between two sharp minds"],
      },
    },
  },
  {
    ...
    phrases: {
      ar: {
        ...
        opening: ["{name}... أعرف مسالك هذا الدرب جيدا"],
        idle: ["الفريسة المترددة... أشهى", "الذئب صبور... والليل طويل"],
        winning: ["القطيع يشم رائحة النصر"],
        losing: ["جراح الذئب تجعله أخطر... احذر"],
        castle: ["اختبأت في العرين؟ الذئب يعرف كل المداخل"],
        promote: ["وزير جديد في الظلام... طريدة أكبر"],
        enPassant: ["انقضاض في المرور! صيد نظيف"],
        draw: ["انتهى الصيد بلا طريدة... هذه المرة"],
      },
      en: {
        ...
        opening: ["{name}... I know every trail of this path"],
        idle: ["Hesitant prey... tastes better", "The wolf is patient... and the night is long"],
        winning: ["The pack smells victory"],
        losing: ["A wounded wolf is a deadlier wolf... beware"],
        castle: ["Hiding in the den? The wolf knows every entrance"],
        promote: ["A new queen in the dark... bigger prey"],
        enPassant: ["A pounce in passing! A clean hunt"],
        draw: ["The hunt ends with no prey... this time"],
      },
    },
  },
  {
    ...
    phrases: {
      ar: {
        ...
        opening: ["{name}... نمط أعرفه، خصم قديم لعبه ضدي"],
        idle: ["صمت طويل... أكاد أسمع دقات قلبك", "فكر جيدا... النمر لا يستعجل فريسته"],
        winning: ["الطوق يضيق... بدقة محسوبة"],
        losing: ["جرحتني... الآن سترى النمر الحقيقي"],
        castle: ["تحصنت... لكن المخالب تصل إلى كل مكان"],
        promote: ["وزير جديد؟ دقتي لا تتغير"],
        enPassant: ["ضربة في المرور... بدقة نمر"],
        draw: ["قوتان متكافئتان... يحدث في الغابة أيضا"],
      },
      en: {
        ...
        opening: ["{name}... a pattern I know; an old rival played it against me"],
        idle: ["Such long silence... I can almost hear your heartbeat", "Think well... a tiger never rushes its prey"],
        winning: ["The circle tightens... with measured precision"],
        losing: ["You wounded me... now you'll see the real tiger"],
        castle: ["Fortified... but claws reach everywhere"],
        promote: ["A new queen? My precision doesn't change"],
        enPassant: ["A strike in passing... tiger precision"],
        draw: ["Two equal forces... it happens in the jungle too"],
      },
    },
  },
  {
    ...
    phrases: {
      ar: {
        ...
        opening: ["{name}... لعبتها قبل أن تولد جبالكم"],
        idle: ["خذ وقتك أيها الفاني... التنانين تعيش آلاف السنين", "تفكيرك الطويل يوقظ فضولي... لا ناري"],
        winning: ["اللهب يلتهم جيشك قطعة قطعة"],
        losing: ["شرر يتطاير من عريني... أنت تلعب بالنار حقا"],
        castle: ["قلعة؟ التنانين تعشش فوق القلاع"],
        promote: ["وزير يدخل النار... شجاعة أم تهور؟"],
        enPassant: ["الأخذ في المرور... سحر قديم قدم التنانين"],
        draw: ["تعادلت مع تنين... احكها لأحفادك"],
      },
      en: {
        ...
        opening: ["{name}... I played it before your mountains were born"],
        idle: ["Take your time, mortal... dragons live for millennia", "Your long thinking stirs my curiosity... not my fire"],
        winning: ["The flames devour your army, piece by piece"],
        losing: ["Sparks fly in my lair... you truly play with fire"],
        castle: ["A castle? Dragons nest atop castles"],
        promote: ["A queen walks into the fire... brave or reckless?"],
        enPassant: ["En passant... magic as old as dragons"],
        draw: ["You drew with a dragon... tell your grandchildren"],
      },
    },
  },
];
...
function botPhrase(bot, kind, sub) {
  const list = bot.phrases[LANG]?.[kind] || bot.phrases.ar[kind] || [];
  const s = list[Math.floor(Math.random() * list.length)] || "";
  return sub ? s.replace("{name}", sub) : s;
}
